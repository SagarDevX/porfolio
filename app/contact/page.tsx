    ...
    return (
        <Container>
            <div className='min-h-fit pb-4'>
                ...
                <form onSubmit={onSubmit} className='flex flex-col gap-6 py-8 px-12 my-12 mx-28 border border-neutral-300 dark:border-neutral-600 rounded-2xl outline outline-offset-4 outline-neutral-300 dark:outline-neutral-600 '>
                ...
                <div className='flex flex-col items-center justify-between gap-1 pt-7 border-t border-neutral-300'>
